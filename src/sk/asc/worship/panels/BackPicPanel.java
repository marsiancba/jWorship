...
import sk.asc.worship.Bookmark;
import sk.asc.worship.Bookmarks;
import sk.asc.worship.ClickButton;
import sk.asc.worship.DialogAssist;
import sk.asc.worship.DirBrowser;
import sk.asc.worship.FormatButton;
import sk.asc.worship.MyAction;
import sk.asc.worship.PictureBookmarks;
import sk.asc.worship.Screen;
import sk.asc.worship.ThumbnailList;
	...
	private FormatButton getFormatButton() {
		if (formatButton == null) {
			...
			formatButton.setIcon(new ImageIcon(getClass().getResource(
					"/sk/asc/worship/backgroundFillScreen.png")));
			formatButton.setIcon(new ImageIcon(getClass().getResource(
					"/sk/asc/worship/backgroundFillScreen.png")));
	...
	private ClickButton getClickButton() {
		if (clickButton == null) {
			...
			clickButton.setIcon(new ImageIcon(getClass().getResource(
					"/sk/asc/worship/previousImage.png")));
